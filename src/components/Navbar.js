          ...
          <div className="collapse navbar-collapse" id="nav">
            <ul className="navbar-nav navbar-right">
                ...
                >
                  <li>
                    <a
                      ...
                      href="/lgbtq/programs/advising.html"
                    >
                      Advising
                    </a>
                  </li>
                  <li>
                    <a
                      className="dropdown-item"
                      href="/lgbtq/programs/events.html"
                    >
                      Events
                    </a>
                  </li>
                  <li>
                    <a
                      className="dropdown-item"
                      href="/lgbtq/programs/rainbow-programs.html"
                    >
                      Rainbow Programs
                    </a>
                  </li>
              ...
              >
                ...
                >
                  <li>
                    <a className="dropdown-item" href="/lgbtq/resources.html">
                      Resources
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="/lgbtq/rights.html">
                      Rights
                    </a>
                  </li>
                </ul>
